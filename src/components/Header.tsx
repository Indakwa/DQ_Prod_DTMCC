  ...
  return <header className="absolute top-0 left-0 right-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 h-[150px]">
          <img src={logo} alt="Team meeting in coworking space" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-6 py-2 border-2 border-white-900 text-white rounded-full text--900 font-medium hover:bg-gray-900 hover:text-white transition-colors">
            Get started
          </button>
        </div>
      </div>
