...
export function Footer() {
  ...
  const footerLinks = {
    prep: {
      title: 'Spaces',
      links: ['Hot Desks', 'Private Offices', 'Boardrooms']
    },
    products: {
      title: 'Membership',
      links: ['Day Pass', 'Weekly Pass', 'Monthly Plans']
    },
    company: {
      title: 'Company',
      links: ['About DTMCC', 'DQ Ecosystem', 'Insights']
    },
    developer: {
      title: 'Community',
      links: ['Events', 'Networking', 'Refer a Member']
    },
    support: {
      title: 'Support',
  ...
  return <footer className="bg-gray-900 text-white">
            ...
            <div>
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <button type="submit" className="px-6 py-3 bg-[#f92900] text-white-900 font-medium rounded-lg hover:bg-[#f92900] transition-colors">
                    Subscribe
                  </button>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            <div className="h-[200px]">
              <img src={logo} alt="Team meeting in coworking space" className="w-full h-full object-contain" />
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© 2025 DQ DWS. All rights reserved.</p>
        </div>
      </div>
    </footer>;
}